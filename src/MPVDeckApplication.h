...
public:
  ...
  auto run() -> int; // NOLINT(cppcoreguidelines-explicit-virtual-functions,modernize-use-override)
...
private:
  ...
  auto setupConfigAndUI() -> void; // NOLINT(modernize-use-trailing-return-type)
  auto restoreWindowState() -> void; // NOLINT(modernize-use-trailing-return-type)
};
