...
class InterfaceOsdViewModel : public QObject {
  ...
  Q_PROPERTY(QString screenshotDirectory READ screenshotDirectory WRITE // NOLINT(modernize-use-trailing-return-type)
...
private:
  int m_osdLevel = 1;
  int m_osdFontSize = MPVDeck::Constants::DEFAULT_OSD_FONT_SIZE; // NOLINT(cppcoreguidelines-non-private-member-variables-in-classes)
  int m_osdDuration = MPVDeck::Constants::DEFAULT_OSD_DURATION; // NOLINT(cppcoreguidelines-non-private-member-variables-in-classes)
  bool m_osc = true;
