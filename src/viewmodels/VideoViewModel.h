...
class VideoViewModel : public QObject {
    ...
    Q_PROPERTY(QString videoProfile READ videoProfile WRITE setVideoProfile NOTIFY videoProfileChanged)
    Q_PROPERTY(QString videoScale READ videoScale WRITE setVideoScale NOTIFY videoScaleChanged)
    ...
    Q_PROPERTY(bool videoDeband READ videoDeband WRITE setVideoDeband NOTIFY videoDebandChanged)
