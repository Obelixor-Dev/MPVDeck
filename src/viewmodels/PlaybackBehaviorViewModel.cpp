...
auto PlaybackBehaviorViewModel::loopFile() const -> QString {
  return m_loopFile;
}
...
auto PlaybackBehaviorViewModel::keepOpen() const -> QString {
  return m_keepOpen;
}
...
auto PlaybackBehaviorViewModel::autofitLarger() const -> QString {
...
auto PlaybackBehaviorViewModel::ytdlRawOptions() const -> QString {
  return m_ytdlRawOptions;
}

void PlaybackBehaviorViewModel::setYtdlRawOptions(
    const QString &ytdlRawOptions) {
