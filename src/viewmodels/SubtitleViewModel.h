...
class SubtitleViewModel : public QObject {
    Q_OBJECT
    Q_PROPERTY(bool subtitleVisibility READ subtitleVisibility WRITE setSubtitleVisibility NOTIFY subtitleVisibilityChanged)
    ...
    Q_PROPERTY(QString subtitleLanguages READ subtitleLanguages WRITE setSubtitleLanguages NOTIFY subtitleLanguagesChanged)
