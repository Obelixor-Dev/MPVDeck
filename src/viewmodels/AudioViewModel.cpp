...
auto AudioViewModel::audioChannels() const -> QString { return m_audioChannels; }
...
auto AudioViewModel::audioNormalizeDownmix() const -> bool { return m_audioNormalizeDownmix; }
